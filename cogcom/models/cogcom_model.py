...
class ImageMixin(BaseMixin):
    def __init__(self, args):
        ...
        self.vit_model = EVA2CLIPModel(
            EVA2CLIPModel.get_args(**vars(vit_args))
        )
...
class CogCoMModel(LLaMAModel):
    def __init__(self, args, transformer=None, parallel_output=True, **kwargs):
        ...
        self.add_mixin(
            ...
            LlamaVisionExpertFCMixin(
                args.hidden_size, args.inner_hidden_size, args.num_layers, 32
            ),
        )
        ...
        self.add_mixin(
            ...
            LlamaVisionExpertAttnMixin(
                args.hidden_size, args.num_attention_heads, args.num_layers, 32
            ),
        )
    ...
    def add_model_specific_args(cls, parser):
        group = parser.add_argument_group(
            "VisualGLM", "VisualGLM Configurations"
        )
    ...
    def forward(
        self, input_ids, vision_expert_mask, image_embed_mask, **kwargs
    ):
...
class FineTuneTrainCogCoMModel(CogCoMModel):
    def __init__(
        self, args, transformer=None, parallel_output=True, **kw_args
    ):
        super().__init__(
            args,
    ...
    def add_model_specific_args(cls, parser):
        group = parser.add_argument_group(
            "CogCoM-finetune", "CogCoM finetune Configurations"
        )
...
class FineTuneTestCogCoMModel(CogCoMModel):
    def __init__(
        ...
        if args.use_lora:
            ...
            self.get_mixin("eva").vit_model.add_mixin(
                "lora",
                LoraMixin(
