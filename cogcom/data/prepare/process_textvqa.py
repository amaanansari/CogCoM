    ...
    def create_data(
        ...
        for sid, split in enumerate(self.splits):
            ...
            for c_data in tqdm.tqdm(data):
                ...
                all_results[image_path] = all_results.get(image_path, []) + [
                    c_data
                ]
                tot_item_num += 1
            ...
            print(
                f"[TextVQA - {split}]: #images/#total = {count}/{len(all_results)}, #QAs/#total = {item_num}/{tot_item_num}"
            )
